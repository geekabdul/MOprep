...
const QuestionScreen = props => {
  ...
  const AllquesDataFunc = async () => {
    try {
      ...
      const response = await axios.post(
        `${BASE_URL}questionBankQuestions`,
        params,
        {
          headers: {
  ...
  const QuitSummarySave = async summaryData => {
    try {
      ...
      const response = await axios.post(`${BASE_URL}questionBankQuit`, params, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
          ...
          <View
            ...
            <View
              ...
              <Text
                ...
                Return to the main menu. You can resume your test from this
                point at any time
              </Text>
            </View>
            <View
